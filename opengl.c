...
void openGL(){
	...
	for(;;){
		if(settings & 0x80){
			...
			glUniform3f(glGetUniformLocation(shaderProgram, "playerDir"), playerDir.x, playerDir.y, playerDir.z);
			glUniform3f(glGetUniformLocation(shaderProgram, "playerDirRight"), playerDirRight.x, playerDirRight.y, playerDirRight.z);
			glUniform3f(glGetUniformLocation(shaderProgram, "playerDirUp"), playerDirUp.x, playerDirUp.y, playerDirUp.z);
